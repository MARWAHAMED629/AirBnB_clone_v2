#!/usr/bin/python3
"""This mdl defines the class to manage database storage for hbnb clone"""
import os
...
class DBStorage:
    """This class manages the storage of hbnb models in a SQL database"""
    __engine = None
    __session = None
    ...
    def __init__(self):
        ...
        db_n = os.getenv('HBNB_MYSQL_DB')
        env = os.getenv('HBNB_ENV')
        DATABASE_URL = "mysql+mysqldb://{}:{}@{}:3306/{}".format(
            user, pword, host, db_n
        )
        ...
        if cls is None:
            for class_type in all_classes:
                ...
                for obj in query.all():
                    object_k = '{}.{}'.format(obj.__class__.__name__, obj.id)
                    objects[object_k] = obj
        else:
